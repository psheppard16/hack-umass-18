...
INSTALLED_APPS = [
    ...
    'nested_inline',
    'import_export',
    'placeholder_app.apps.PlaceholderConfig',
]
...
LOGGING = {
    ...
    'handlers': {
        ...
        'placeholder': {
            ...
            'filename': os.path.join(LOG_DIR, 'placeholder.log'),
            'maxBytes': 50000,
            'backupCount': 2,
            'formatter': 'standard',
        },
...
from placeholder.settings_secret import *